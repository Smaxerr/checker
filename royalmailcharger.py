...
async def run_royalmailcharger(user_id: int, card_details: str):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Wait up to 5 seconds for either PB or other
            clicked = False
            for _ in range(5):  # try every 1 second
            ...
            if not clicked:
                print("Neither PB nor other appeared within 5 seconds")
            ...
            await asyncio.sleep(10)  # small wait to ensure dynamic content loads fully
